const defaultModules = [
  ...
  { number: "02", slug: "open-models", title: "开源模型应用", tag: "视觉工作流", description: "以 ComfyUI 为视觉工作流入口，理解参考控制、局部修正、版本复现与团队交接。", question: "怎样让视觉生成从碰运气，变成可控制、可复现的过程？", points: ["参考图、构图与局部控制", "工作流、节点与版本记录", "从主视觉探索到方案板输出"] },
